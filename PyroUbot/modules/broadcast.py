...
__HELP__ = """
<b>-- 📦 Folder Untuk Broadcast --</b>

<blockquote><b>🚀 Perintah : <code>{0}gikes</code>
📝 Type : all , users , group
🔎 Example : .gikes group [ Reply ]</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}stopg</code>
📝 Penjelasan : untuk menghentikan proses gikes yang sedang berlangsung</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}bcfd</code> or <code>{0}cfd</code>
📝 Penjelasan : mengirim pesan siaran secara forward
🔎 Example : .bcfd group [ Reply ]</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}sends</code>
📝 Penjelasan : mengirim pesan ke user/group/channel</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}autobc</code>
📝 Penjelasan : mengirim pesan siaran secara otomatis</b></blockquote>
