...
__MODULE__ = "ɴᴏᴛᴇ"
__HELP__ = """
<b>-- 📦 Folder Untuk Notes --</b>

<blockquote><b>🚀 Perintah : <code>{0}addnote</code> [name]
📝 Penjelasan : menyimpan sebuah catatan</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}addcb</code> [name]
📝 Penjelasan : menyimpan sebuah callback</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}get</code> [name]
📝 Penjelasan : mendapatkan catatan yang di simpan</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}delnote</code> [name]
📝 Penjelasan : menghapus catatan yang di simpan</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}delcb</code> [name]
📝 Penjelasan : menghapus callback yang di simpan</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}listnote</code>
📝 Penjelasan : melihat daftar catatan yang di simpan</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}listcb</code>
📝 Penjelasan : melihat daftar callback yang di simpan</b></blockquote>

<blockquote><b>🔍 For button:
format | nama tombol - url/callback |</b></blockquote>
<blockquote><b>🔍 Payment | dana - dana | | bank - bank # |</b></blockquote>

<blockquote></b>⚠️ Catatan : untuk membuat button menyamping adalah #
contoh menggunakan callback/tombol : <a href='https://t.me/halopyrogram/174'>tutorial</a></b></blockquote>
"""
