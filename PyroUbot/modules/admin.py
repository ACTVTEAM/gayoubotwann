...
__MODULE__ = "ᴀᴅᴍɪɴ"
__HELP__ = """
<b>-- 📦 Folder Untuk Admin --</b>

<blockquote><b>🚀 Perintah : <code>{0}kick</code> |<code>{0}ban</code> |<code>{0}mute</code> |<code>{0}etmin</code> |<code>{0}ceo</code> |<code>{0}demote</code>
<code>{0}unmute</code> |<code>{0}unban</code></b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}zombies</code> [in group]
📝 Penjelasan : mengeluarkan akun terhapus dari group</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}lock</code> | <code>{0}unlock</code> | <code>{0}locks</code>
📝 Penjelasan : mengunci/membuka dan list izin group</b></blockquote>
