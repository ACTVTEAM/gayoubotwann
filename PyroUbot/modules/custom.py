...
__MODULE__ = "ᴄᴜꜱᴛᴏᴍ"
__HELP__ = """
<b>-- 📦 Folder Untuk Custom --</b>

<blockquote><b>🚀 Perintah : <code>{0}lihatemoji</code></b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}text</code>
📝 Penjelasan : untuk merubah text pada tampilan tertentu</b></blockquote>

<blockquote><b>🔎 Query :
<code>{0}pong<code> | default : ± pong
<code>{0}owner<code> | default : ± owner
<code>{0}ubot<code> | default : ± ubot</b></blockquote>

</b><blockquote>🔎 Contoh :
<code>{0}</code>text pong none | untuk menyeting ke default</b></blockquote>
"""
