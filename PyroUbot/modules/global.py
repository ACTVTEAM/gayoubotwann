...
__MODULE__ = "ɢʟᴏʙᴀʟ"
__HELP__ = """
<b>-- 📦 Folder Untuk Global --</b>

<blockquote><b>🚀 Perintah : <code>{0}gban</code>
📝 Penjelasan : banned user dari semua group chat</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}ungban</code>
📝 Penjelasan : unbanned user dari semua group chat</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}gmute</code>
📝 Penjelasan : untuk mengemute user dari semua gc yg kmu admin</b></blockquote>
<b><blockquote>🚀 Perintah : <code>{0}ungmute</code>
📝 Penjelasan : untuk meng ungmute user dari semua gc yg kmu admin</b></blockquote> 
"""
