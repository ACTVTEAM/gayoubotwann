...
__MODULE__ = "ꜱᴛɪᴄᴋᴇʀ"
__HELP__ = """
<b>-- 📦 Folder Untuk Sticker --</b>

<blockquote><b>🚀 Perintah : <code>{0}q</code>
📝 Penjelasan : merubah text menjadi sticker</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}kang</code>
📝 Penjelasan : menambahkan sticker ke dalam pack</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}tiny</code>
📝 Penjelasan : merubah sticker menjadi kecil</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}mmf</code>
📝 Penjelasan : sticker atau foto akan di ubah menjad sticker text</b></blockquote>
"""
