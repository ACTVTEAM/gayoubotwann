...
__MODULE__ = "ᴍɪꜱᴄ"
__HELP__ = """
<b>-- 📦 Folder Untuk Misc --</b>

<blockquote><b>🚀 Perintah : <code>{0}limit</code>
📝 Penjelasan : mengecek status akun apakah terkena limit atau tidak</b></blockquote>
...
📝 Penjelasan : merubah qrcode text menjadi gambar</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}qrRead</code>
📝 Penjelasan : merubah qrcode media menjadi text:</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}tg</code>
📝 Penjelasan : mengapload media/text ke telegra.ph</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}font</code>
📝 Penjelasan : merubah text menjadi berbeda</b></blockquote>
"""
