...
__MODULE__ = "ᴘʀᴏꜰɪʟᴇꜱ"
__HELP__ = """
<b>-- 📦 Folder Untuk Profiles --</b>

<blockquote><b>🚀 Perintah : <code>{0}setbio</code>
📝 Penjelasan : mengubah bio pada akun anda</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}setname</code>
📝 Penjelasan : mengubah nama pada akun anda:</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}block</code>
📝 Penjelasan : memblokir pengguna</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}unblock</code>
📝 Penjelasan : membuka pemblokiran pada pengguna</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}sg</code>
📝 Penjelasan : memeriksa histori name pengguna telegram</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}info</code>
📝 Penjelasan : melihat informasi data akun telegram</b></blockquote>
<blockquote><b>🚀 Perintah : <code>{0}cinfo</code>
📝 Penjelasan : melihat informasi data group/channel telegram</b></blockquote>
"""
